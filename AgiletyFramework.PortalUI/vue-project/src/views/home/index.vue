    ...
    <div class="module-box">
        ...
        <div style="flex: 0 1 30%;margin: 5px;">
            <el-card class="box-card">
                <Chart :title="materialData.title" :chartType="materialData.chartType" :chartData="materialData.chartData"
                    :chartxAxis="materialData.chartxAxis" :color="materialData.color" />
            </el-card>
        </div>
